...
class GenericGenerator(Dataset): # 將dataset做數據增強，最後存成state_dict
    def __init__(self, dataset, trace_name=False):
        """
    ...
    def __getitem__(self, idx):
        ...
        if not self.trace_name:
            ...
            state_dict = {k: v[0] for k, v in state_dict.items()}
            state_dict['trace_name'] = state_dict['X'][1]['trace_name_original']
